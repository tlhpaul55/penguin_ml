...
st.write("This app uses 6 inputs to predict the species of prenuin \
        using a model built on the Palmer's Penguin's dataset.  Use \
...
with st.form('user_input'):
    island = st.selectbox('Penguin Island', options=['Biscoe',
                                            'Dream', 'Torgerson'])
...
st.write('We use a machine learning (Random Forest) model to \
...
st.write('Below are the histograms for each continuous variable \
        separated by penguin species.  The verticle line \
